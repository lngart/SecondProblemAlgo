...
template <typename T>
void find_shortest_way(IGraph<T> &graph, std::vector<T> &parent, std::vector<T> &distance,
                       std::vector<T> &vertices_on_way, T starting_vertex, T ending_vertex) {
...
void print_shortest_way(IGraph<T> &graph, T starting_vertex, T ending_vertex) {
    std::vector<T> parent(graph.size(), std::numeric_limits<T>::max()),
        distance(graph.size(), std::numeric_limits<T>::max()), vertices_on_way;

    find_shortest_way(graph, parent, distance, vertices_on_way, starting_vertex, ending_vertex);
